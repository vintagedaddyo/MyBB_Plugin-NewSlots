...
Plugin Description: This is a simple slot machine for risking your NewPoints points in the hopes of winning more.  Currently you can set how much each spin costs in admincp.  The win is decided on a multiplication of the spin cost.  The top 2 wins are hard to achieve as I have created an extra random algorithm for them.  NewPoints plugin is of course required.

Installation

1. Upload the contents within the Upload directory to your forums root directory
...
Note: This version has language support. 
